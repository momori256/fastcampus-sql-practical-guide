...
CREATE TABLE WA_MarketingCampaign
(
    MarketID INTEGER,
    MarketSize TEXT,
    LocationID INTEGER,
    ...
    Promotion INTEGER,
    week INTEGER,
    SalesInThousands REAL
);

INSERT INTO WA_MarketingCampaign (MarketID,MarketSize,LocationID,AgeOfStore,Promotion,week,SalesInThousands)
VALUES 
